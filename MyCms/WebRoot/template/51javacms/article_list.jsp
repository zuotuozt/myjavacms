...
<body>
	...
	<div id="main">
		<div class="left">
			<!-- 左侧导航开始 --><%@ include file="left.jsp"%><!-- 左侧导航结束 -->
		</div>
		<div class="right">
			<!-- 内容区域开始 -->
			<div class="column">
				...
				<div class="b">
					<div class="h2">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="center"><b>标题</b>
								</td>
								<td width="400"> </td>
								<td align="center"><b>日期</b>
								</td>
							</tr>
						</table>
					</div>
					<div class="bin">
						<ul class="list">
							<51java:arlist>
							<li<51java:if test="${article.top}">class="up"</51java:if>><span
								class="date"> <51java:formatdate format="yyyy-MM-dd"
									datetime="${article.creatime}" /></span> <a href="${article.url}"
								target="_blank">${article.title}</a> <51java:if
								test="${article.top}"><img src="<51java:webroot/>/images/up.gif" /></51java:if>
							</li> </51java:arlist>
						</ul>
						<51java:if test="${totalpage>1}">
						<div><%@ include file="../system/page/page2.jsp"%></div>
						</51java:if>
					</div>
				</div>
				<!-- 内容区域结束 -->
